...
--
-- Host: localhost
-- Generation Time: Dec 02, 2015 at 08:46 PM
...
(1, '0000-00-00', '加拿大留学大签？小签？傻傻分不清楚？分分钟让你秒懂!', '加拿大留学中心', '对于想去加拿大的学生来说，加拿大的大签和小签是必定要了解的。近来发现很多学生及家长对这个大小签有种种的误解，下面我们就来具体看下，加拿大留学用到的大小签有哪些区别。\r\n\r\n大签（Study Permit）学生在入境加拿大时移民局(或海关)所发的学习许可“Study Permit”, 就是我们俗称的加拿大大签。学生在第一次入境时，机场会有专门提供换取study permit的移民局办公室，处理的人员是移民局的移民官。Study permit是一张绿色纸质文件，A4大小，会被订在学生的护照上，以防丢失。它是学生在加拿大读书的凭证，具有法律效益，学生一定要妥善保管，大签到期都必须及时续签。注意：这个许可证只是允许学生居留加拿大上学读书，证明学生在加拿大的合法学生身份，但是不能作为持有者出入加拿大国境的凭证。\r\n\r\n此学习许可由加拿大境内移民局发放。学习许可的有效期通常为1年，这里一定注意到期要在当地移民局申请延期。一般情况下，申请人如果能顺利完成第一年课程，可以申请将学习许可的有效期延长至学习结束期满。\r\nPS：因大签是有一定有效期的，如果大签到期未续签且情况严重者，一般不能超过3个月再续签，否则会被移民局视为非法滞留，导致续签拒签。续签Study Permit 申请必须在Visa有效期内提交申请。', 'image_1.png'),
